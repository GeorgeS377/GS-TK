...
(function () {
    ...
    -1 < window.location.hash.indexOf("bg=black") && (document.body.style.background = "#000");
    ...
    function g(a) {
        ...
        }, 400)), a = document.createElement("script"), a.type = "text/javascript", a.src = "/games/pacman/logos/js/pacman10-hp.12.js", (document.getElementById("xjsc") || document.body).appendChild(a))
    }
