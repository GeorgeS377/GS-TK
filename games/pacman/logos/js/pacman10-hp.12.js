(function () {
   ...
   */
    ...
    var y, z, ad, bd, A, cd, B, C, dd, D, ed, E, fd, gd, hd, id, F, jd, kd, G, H, I, ld, md, J, K, nd, od, pd, qd, rd,
        sd, M, td, ud, vd, wd, xd, yd, zd, Ad, Bd, Cd, N, Dd, Ed, Fd, Gd, Hd, Id, O, Jd, Kd, Ld, Md, Nd, Od, Pd, Qd, Rd,
        Sd, Td, Ud, Vd, Wd, Xd, Yd, Zd, P, $d, ae, Q, be, ce, de, ee, fe, ge, R, he, ie, je, ke, le, me, ne, oe,
        pe = [1, 4, 2, 8],
        S = {
            0: {
                axis: 0,
    ...
    var Ve = function (a) {
        ...
        kf = function (a) {
            ...
            b && (a += "&ntp=1");
            -1 == a.search("&ei=") && (a += "&ei=", Ec || (window.google && window.google.kEI && window.google.kEI.length ? Ec = window.google.kEI : document.querySelector("body#iframedoodle") &&
    ...
    Ff || (ce.onload = Bf);
    ce.src = "/games/pacman/logos/pacman10-hp-sprite-3.png";
    Ff && Bf();
    0 == function () {
        if (!Oc) return !0;
        try {
